...
declare function rightShift(s: string, bits: number, char: string = '0'): string
...
declare function uniqueBy(a: any[], prop: string, byRef: boolean = false): any
